...
#### If any issues connecting to kibana to verify ,please use 
*"kubectl get all --all-namespaces"* 
#### to verify node where pod is hosted, this will be replaced with replica set of ingress controllers from traefik.
